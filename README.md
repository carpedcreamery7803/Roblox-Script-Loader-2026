...
- Multiple executor support including Volt, Synapse Z, Potassium, and Wave
- Universal loader (xcutorsLoader) for easy script execution
- Windows desktop application for stability and performance
- Full Lua script compatibility
- Regular updates for executor and game compatibility
...
XCutors is a collection of Roblox executors and a script loader designed for Windows desktop use.

### Is XCutors free to use?

Yes, XCutors is an open-source project available for free on GitHub.

### Which executors are included in XCutors?

XCutors includes Volt, Synapse Z, Potassium, Wave, and the xcutorsLoader universal loader.

### How do I install XCutors on Windows?

Download the release from GitHub, extract, run the installer, and follow the steps.

### Is XCutors safe from components?

We prioritize security and perform regular scans, but always use caution with any third-party software.
...
You can open an issue on the GitHub repository with detailed information.
